...
const contactMethods = [
  {
    icon: Mail,
    label: 'Email',
    value: 'roshansinghparmar77@gmail.com',
    href: 'mailto:roshansinghparmar77@gmail.com',
    bg: 'bg-blue-700',
  ...
  },
  {
    icon: Github,
    label: 'GitHub',
    value: 'github.com/Roshan-Parmar',
    href: 'https://github.com/Roshan-Parmar',
    bg: 'bg-gray-700',
    iconColor: 'text-white',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'linkedin.com/in/roshan-parmar-6298122ba',
    href: 'www.linkedin.com/in/roshan-parmar-6298122ba',
    bg: 'bg-blue-800',
    iconColor: 'text-white',
  },
];
...
const codingPlatforms = [
  {
    icon: LeetCodeIcon,
    label: 'LeetCode',
    href: 'https://leetcode.com/u/roshan_parmar/',
    bg: 'bg-white',
    iconColor: '',
  },
  {
    ...
    <CardContent>
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-lg p-4 border border-orange-500/30">
          <div className="text-2xl font-bold text-orange-400 mb-1">6 Mon</div>
      ...
      <div className="mb-6">
        ...
        <div className="flex justify-center">
          <div id="SocailIcons" className="relative">
            {/* Instagram */}
            <a href="https://www.instagram.com/roxhanp_?igsh=ZDF0eXJpN2t2bDBw&utm_source=ig_contact_invite" target="_blank" rel="noopener noreferrer" className="icons instaIcon group">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/roshan-parmar-6298122ba" target="_blank" rel="noopener noreferrer" className="icons linkedin group">
            ...
            {/* YouTube */}
            <a href="https://www.youtube.com/@roshans..creation2956" target="_blank" rel="noopener noreferrer" className="icons youtube group">
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          access_key: 'a16a7664-3b0b-4819-9275-7ed24052fb13',
