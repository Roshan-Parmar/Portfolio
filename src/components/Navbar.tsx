        ...
        <div className="flex items-center h-full">
          ...
          <a href="#" className="relative group flex items-center justify-center">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-500 to-blue-900 rounded-full blur-2xl opacity-60 group-hover:opacity-100 transition-all duration-500"></div>
            </div>
            <img 
              src="/lovable-uploads/ChatGPT Image Dec 12, 2025, 10_03_02 PM.png" 
              alt="Roshan Logo" 
