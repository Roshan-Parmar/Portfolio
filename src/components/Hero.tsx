...
const Hero = () => {
  ...
  const GOOGLE_DRIVE_FILE_ID = '121amS-a4rs5Wuttl7nes8ozgXO4OjanG'; // Replace with your actual file ID
// https://drive.google.com/file/d/121amS-a4rs5Wuttl7nes8ozgXO4OjanG/view?usp=drive_link
// https://drive.google.com/file/d/121amS-a4rs5Wuttl7nes8ozgXO4OjanG/view?usp=sharing
  ...
  const handleResumeDownload = () => {
    ...
    link.href = 'https://drive.google.com/uc?export=download&id=' + GOOGLE_DRIVE_FILE_ID;
    link.download = 'RoshanResume.pdf';
    link.click();
  };
    ...
    <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden pt-36">
      <div className="container mx-auto px-6 z-10 relative">
        <div className="max-w-6xl mx-auto text-center px-4">
          ...
          >
            <span className="block">Hi, I'm Roshan Parmar</span>
          ...
          >
            <a href="https://github.com/Roshan-Parmar" target="_blank" rel="noopener noreferrer" className="group">
            ...
            <a href="https://www.linkedin.com/in/roshan-parmar-6298122ba" target="_blank" rel="noopener noreferrer" className="group">
              <div className="relative p-3 rounded-xl bg-black/40 backdrop-blur-sm border border-blue-500/20 shadow-[0_0_15px_rgba(59,130,246,0.1)] group-hover:shadow-[0_0_30px_rgba(59,130,246,0.3)] transition-all duration-300">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-600/0 via-blue-600/10 to-purple-600/0 rounded-xl blur-3xl opacity-0 group-hover:opacity-100 transition-all duration-500 scale-150 group-hover:scale-100"></div>
